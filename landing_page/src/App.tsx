    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-blue-900/70 flex items-center">
          <div className="max-w-7xl mx-auto px-4 text-white">
            ...
            <p className="text-xl max-w-2xl">
              Providing comprehensive healthcare services with state-of-the-art facilities
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <ServiceCard
            ...
            description="Access to top-tier medical facilities and healthcare professionals"
          />
          <ServiceCard
            Icon={Ambulance}
      ...
      <div className="bg-blue-600 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8">Our team is available 24/7 to help you with any medical emergencies</p>
